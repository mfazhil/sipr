  ...
  <div class="header-wrapper">
    ...
    <nav class="nav">
      <ul class="nav__list">
        ...
        <li class="nav__item">
          <a href="./pengecekan.php" class="nav__link <?= addActiveClass("pengecekan") . addActiveClass("fuzzy"); ?>">
            <svg class="nav__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav__item">
          <a href="./data-ruangan.php" class="nav__link <?= addActiveClass("data-ruangan") . addActiveClass("rule"); ?>">
            <svg class="nav__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav__item">
          <a href="./daftar-prosedur.php" class="nav__link <?= addActiveClass("prosedur") . addActiveClass("himpunan") ?>">
            <svg class="nav__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
